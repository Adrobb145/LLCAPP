...
.brand-sub{font-size:8px;color:#807E76;letter-spacing:.14em;text-transform:uppercase;margin-top:2px;}
.sb-lbl{font-size:9px;letter-spacing:.14em;text-transform:uppercase;color:#54534D;padding:0 8px 6px;font-weight:600;}
...
.sb-item-ct{margin-left:auto;font-size:10px;color:#807E76;}
...
.kick{font-size:9.5px;letter-spacing:.16em;text-transform:uppercase;color:#807E76;font-weight:600;}
.pill{display:inline-flex;align-items:center;gap:4px;padding:2px 7px;border-radius:3px;font-size:10px;font-weight:600;letter-spacing:.04em;text-transform:uppercase;background:#232327;color:#B5B3AB;}
...
.stat-l{font-size:9.5px;color:#807E76;letter-spacing:.12em;text-transform:uppercase;font-weight:600;}
...
.cc-goal{font-size:10.5px;color:#807E76;margin-top:1px;}
.cc-block{font-size:10px;letter-spacing:.06em;text-transform:uppercase;color:#B5B3AB;font-weight:600;padding:5px 0;border-top:1px solid #2A2A2F;border-bottom:1px solid #2A2A2F;margin-bottom:10px;display:flex;justify-content:space-between;}
.cc-stats{display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;}
.ccs-l{font-size:8.5px;color:#807E76;letter-spacing:.08em;text-transform:uppercase;font-weight:600;margin-bottom:2px;}
.ccs-v{font-family:'Archivo Black',sans-serif;font-size:17px;line-height:1;}
.ccs-u{font-size:9px;color:#807E76;font-weight:400;margin-left:2px;}
...
.chm-l{font-size:8.5px;letter-spacing:.12em;text-transform:uppercase;color:#807E76;font-weight:600;}
.chm-v{font-family:'Archivo Black',sans-serif;font-size:15px;line-height:1;}
.chm-v small{font-weight:400;font-size:10px;color:#807E76;}
...
.meso-l{font-size:9px;letter-spacing:.12em;text-transform:uppercase;color:#807E76;font-weight:600;display:flex;align-items:center;padding-right:12px;border-right:1px solid #2A2A2F;white-space:nowrap;}
.meso-c{display:flex;gap:3px;flex:1;}
.mcell{flex:1;height:22px;border-radius:3px;background:#232327;display:flex;align-items:center;justify-content:center;font-size:10px;font-family:'JetBrains Mono',monospace;color:#807E76;cursor:pointer;border:1px solid transparent;}
...
.dtab-d{font-size:9px;letter-spacing:.1em;text-transform:uppercase;color:#54534D;font-weight:600;}
...
.shrow{background:#1A1A1D;border-bottom:1px solid #2A2A2F;font-size:9px;letter-spacing:.1em;text-transform:uppercase;color:#807E76;font-weight:600;height:28px;}
...
.ex-pat{font-size:9px;color:#807E76;letter-spacing:.08em;text-transform:uppercase;margin-top:2px;}
...
.t-lbl{font-size:8.5px;color:#807E76;letter-spacing:.08em;text-transform:uppercase;}
.l-w{font-family:'JetBrains Mono',monospace;font-size:12.5px;}
.l-m{font-size:9px;color:#807E76;margin-top:1px;}
.sgst{background:rgba(255,107,44,.07);}
.s-w{font-family:'JetBrains Mono',monospace;font-size:13px;color:#FF6B2C;font-weight:700;}
.s-l{font-size:8.5px;color:#FF6B2C;opacity:.8;letter-spacing:.08em;text-transform:uppercase;font-weight:600;}
...
.smeta{display:flex;align-items:center;justify-content:center;gap:5px;font-size:9px;color:#807E76;font-family:'JetBrains Mono',monospace;}
.scheck{position:absolute;top:3px;right:3px;width:12px;height:12px;border-radius:2px;border:1px solid #36363C;cursor:pointer;display:flex;align-items:center;justify-content:center;background:#131315;font-size:9px;line-height:1;}
...
.rnote-l{font-size:8.5px;color:#807E76;letter-spacing:.08em;text-transform:uppercase;font-weight:700;flex-shrink:0;padding-top:1px;}
.addex{display:flex;align-items:center;gap:8px;padding:12px 14px;border-top:1px solid #2A2A2F;}
.addexb{border:1px dashed #36363C;background:transparent;color:#807E76;padding:7px 12px;border-radius:4px;font-family:inherit;font-size:10.5px;font-weight:600;letter-spacing:.04em;text-transform:uppercase;cursor:pointer;}
.addexb:hover{border-color:#FF6B2C;color:#FF6B2C;}
.rail{margin-bottom:24px;}
.rail-t{font-size:9px;letter-spacing:.14em;text-transform:uppercase;color:#807E76;font-weight:700;margin-bottom:9px;display:flex;justify-content:space-between;}
...
.note-m{display:flex;justify-content:space-between;font-size:9px;color:#807E76;letter-spacing:.06em;text-transform:uppercase;font-weight:600;margin-bottom:3px;}
...
.libfl{font-size:9px;letter-spacing:.12em;text-transform:uppercase;color:#807E76;font-weight:700;}
...
.libc-p{font-size:9px;letter-spacing:.1em;text-transform:uppercase;color:#FF6B2C;font-weight:700;}
.libc-m{font-size:10px;color:#807E76;}
.mtag{font-size:9px;letter-spacing:.06em;padding:1px 5px;border-radius:2px;background:#232327;color:#807E76;text-transform:capitalize;display:inline-flex;align-items:center;gap:3px;}
...
.plr.head{background:#1A1A1D;font-size:9px;letter-spacing:.1em;text-transform:uppercase;color:#807E76;font-weight:600;}
...
.plsub{font-size:8.5px;color:#807E76;margin-top:1px;}
