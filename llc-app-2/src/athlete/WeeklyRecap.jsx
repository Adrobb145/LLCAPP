...
export default function WeeklyRecap({client,program,clogs,bodylog,misses,stats,cw,onSend,onClose}){
  ...
  return(<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.7)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:20}} onClick={onClose}>
    <div onClick={e=>e.stopPropagation()} style={{background:D.card,border:`1px solid ${D.line}`,borderTop:"3px solid #3AE0FF",borderRadius:16,padding:18,width:"100%",maxWidth:480,maxHeight:"90vh",overflowY:"auto"}}>
